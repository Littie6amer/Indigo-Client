...
console.log(`[${config.name}]: Searching ./commands`)
loadFolder('./commands')
...
console.log(`~~~`)
console.log(`[${config.name}]: ${commands.size} command(s) loaded!`)
console.log(`[${config.name}]: ${buttons.size} buttons(s) loaded!`)
console.log(`[${config.name}]: ${Object.keys(dropDowns).length} dropdown(s) loaded!`)
console.log(`[${config.name}]: ${slashCommands.size} slash command(s) loaded!`)
console.log(`~~~`)

module.exports = { commands, dropDowns, buttons, restrictions, slashCommands, cooldowns: {} }